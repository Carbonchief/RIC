...
- Used by many open-source Developments: WordPress, Drupal, 1CRM, SugarCRM, Yii, Joomla! and many more
...
Please *don't* use the SourceForge or Google Code Developments any more; they are obsolete and no longer maintained.
...
## History
- PHPMailer was originally written in 2001 by Brent R. Matzelle as a [SourceForge project](http://sourceforge.net/Developments/phpmailer/).
...
- Official successor to the SourceForge and Google Code Developments.
- Test suite.
